...
// BUG FIX: should start as false
// BUG FIX: loop must run through ALL codes (length is 4, not 2)
// BUG FIX: index should be 0, not 1
// BUG FIX: comparison must use ==, not =  
// BUG FIX: logic reversed (true means found)