...
// FIX: for loop condition i < stringLength (not <=)
// FIX: Character.toLowerCase(aString.charAt(i)) (missing dot)
// FIX: count letters using Character.isLetter()
// FIX: corrected print syntax: "The number of LETTERS is " + numLetters